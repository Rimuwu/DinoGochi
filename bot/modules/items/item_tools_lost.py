...
#             if data_item['item_class'] in ['transport']:
...
#             elif data_item['item_class'] in ['defrosting']:
#                 steps += [
#                     # {"type": 'dino', 
#                     #      "name": 'dino', 
#                     #      "data": {"add_egg": False, "all_dinos": False}, 
...
#             elif data_item['item_class'] in ['freezing']:
#                 steps += [
#                     # {"type": 'dino', 
#                     #      "name": 'dino', 
#                     #      "data": {"add_egg": False, "all_dinos": False}, 
...
#             elif data_item['item_class'] in ['premium']:
...
#             elif data_item['item_class'] in ['dino_slot']:
#                 steps = []

#             elif data_item['item_class'] in ['reborn']:
...
#             elif data_item['item_class'] in ['custom_book']:
...
#                     )
#                 ]
#                 transmitted_data['item_id'] = base_item['_id']

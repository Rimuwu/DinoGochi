...
#     if 'item_class' in data_item and data_item['item_class'] in loc_d['type_info']:
#         type_loc: str = data_item['item_class']
#     else:
...
#         if data_item['item_class'] == 'transport':
...
#     if type_item == 'special' and data_item['item_class'] == 'background':

...
@bot.message_handler(pass_bot=True, text='commands_name.live_actions.entertainments', dino_pass=True, nothing_state=True)
...
@bot.message_handler(pass_bot=True, text='commands_name.live_actions.stop_game')

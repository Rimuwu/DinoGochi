...
@bot.message_handler(pass_bot=True, text='commands_name.live_actions.put_to_bed', dino_pass=True)
...
@bot.message_handler(pass_bot=True, text='commands_name.live_actions.awaken')

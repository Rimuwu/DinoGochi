...
class PrivateModelMixin:
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if any(lib in caller_lower for lib in ('pydantic', 'beanie', 'bson', 'motor', 'pymongo', 'contextlib', 'unittest', 'mock', 'pytest', 'tests', 'items.py', 'item_tools.py', 'bot/modules', 'bot/handlers', 'bot/tasks', 'bot\\modules', 'bot\\handlers', 'bot\\tasks', 'donation.py', 'tools')):
            super().__setattr__(name, value)
            return

...
- Запустите файл **config.py** для создания файла конфига
- В config.json, 
> - bot_token: "Токен бота из BotFather"
> - bot_devs: [id админов бота]

- Если у вас локальная база, можете ничего не делать
- Если у вас бота на виртуалной машине
1. Установить ssh_pymongo
2. Укажите в config.json все данные для подключения
- Или вы можете изменить mongo_url для подключения к бесплатным кластерам монги
